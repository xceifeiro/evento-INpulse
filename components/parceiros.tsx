  ...
  const sponsorLogos = [
    ...
    <section className="pt-10">
        <div className="container px-4 md:px-6">
          <h2 className="text-3xl md:text-4xl font-bold text-[#821423] mb-8">Parceiros Oficiais</h2>
          <p className="text-lg text-gray-700 mb-8">
            Conheça as empresas que estão fazendo parte do INpulse e apoiando o Network desse evento.
          </p>
